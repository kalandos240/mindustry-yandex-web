...
subprocess.run([sys.executable, str(root / "scripts" / "patch-mindustry-weather-playing-web.py")], check=True)
...
subprocess.run([sys.executable, str(root / "scripts" / "patch-browser-player-mining-smoke.py")], check=True)
...
subprocess.run([sys.executable, str(root / "scripts" / "patch-browser-campaign-continue-verifier.py")], check=True)
