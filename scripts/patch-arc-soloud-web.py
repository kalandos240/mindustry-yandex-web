...
# Main's BrowserAudio Arc patch removes native playback from the reachable base classes.
# Keep this additional boundary for gameplay code that may still make Soloud.java itself
# reachable through filters or future stock paths: no JNI method may survive in TeaVM.
if len(methods) < 30:
