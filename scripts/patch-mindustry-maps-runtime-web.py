...
new = '''        // Web/Yandex: builtin map metadata/world loading does not need desktop preview\n        // generation. Registering createAllPreviews here makes its mainExecutor/Future\n        // PNG-cache path reachable in TeaVM even when no preview is ever requested.\n'''
if old not in text:
...
if "createAllPreviews" in constructor or "ContentLoader.class" in constructor:
