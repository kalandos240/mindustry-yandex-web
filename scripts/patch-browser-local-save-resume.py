...
old_queries = '''    @JSBody(script = "var q=new URLSearchParams(location.search); return q.get('mindustryPauseSmoke')==='1'||q.get('mindustryCampaignPauseSmoke')==='1';")\n    private static native boolean pauseSmokeRequested();\n\n    @JSBody(script = "return new URLSearchParams(location.search).get('mindustryGameOverSmoke') === '1';")\n'''
